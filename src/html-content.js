      ...
      <div class="sidebar">
        <div class="sidebar-card" id="profileCard" style="display:none;">
          ...
          <div class="avatar-action-btns">
            <button class="avatar-btn-upload" onclick="document.getElementById('avatarFileInput').click()" title="Upload a profile photo">
            ...
            <button class="avatar-btn-remove" id="avatarRemoveBtn" onclick="removeAvatar()" title="Remove profile photo" style="display:none;">
